...
public class AllAppointmentAdapter extends RecyclerView.Adapter<AllAppointmentAdapter.ViewHolder> {
    ...
    public void onBindViewHolder (ViewHolder holder, int position) {//        runEnterAnimation (holder.itemView);
        ...
        holder.appointment_id.setText (String.valueOf (appointment.getId ()));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder (View view) {
            super (view);
            service_type = (TextView) view.findViewById (R.id.tvMakeAndModel);
            status = (TextView) view.findViewById (R.id.tvRegistrationNumber);
            car_registration_number = (TextView) view.findViewById (R.id.tvFuelType);
